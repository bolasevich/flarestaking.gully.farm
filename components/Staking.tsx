        ...
        return (
            <div style={{
                ...
                {/* <div style={{
                    ...
                    <h2 style={{ marginRight: "20px", color: "#fff"}}>Claim NFT to Stake</h2>
                    <TransactionButton
                        transaction={() => (
                            claimTo({
                                contract: NFT_CONTRACT,
                ...
                <div style={{ 
                    ...
                    <h2 style={{ color: "#fff"}}>Owned NFTs</h2>
                    <div style={{ display: "flex", flexDirection: "row", flexWrap: "wrap", width: "450px"}}>
                        {ownedNFTs && ownedNFTs.length > 0 ? (
                            ...
                            <p style={{ color: "#fff"}}>You own 0 NFTs</p>
                        )}
                    </div>
                </div>
                <hr style={{
                ...
                <div style={{ width: "100%", margin: "20px 0" }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "row", flexWrap: "wrap", width: "450px"}}>
                        {stakedInfo && stakedInfo[0].length > 0 ? (
                            ...
                            <p style={{ margin: "20px", color: "#fff" }}>No NFTs staked</p>
                        )}
                    </div>
                </div>
            </div>
